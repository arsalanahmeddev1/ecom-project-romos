                  ...
                  <div class="cart-content">
                      <div class="row">
                          <div class="col-lg-7 col-xl-8 col-12">
                              ...
                              <div class="cart-prod">
                                  <div class="row align-items-center prod-c-m">
                                      <div class="col-lg-6 col-6">
                                          <div class="d-flex align-items-center ">
                                              <div>
                                                  <img src="./assets/images/cart-prod-img.png" class="img-fluid" alt="">
                                              </div>
                                              <div class="ms-4 ">
                                                  <h5 class="text-sm-hd-2 mb-0 ">AENEAN EGET RISUS UIS <br> LIGULA QUIS VIVE</h5>
                                                  <a href="./shop-views.php" class="text-mini-md-3 secondry-color ul">View Store</a>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="col-lg-6 col-6">
                                          <div class="row align-items-center">
                                              ...
                                              <div class="col-lg-5 col-6 col-md-5">
                                                  <div class="counter">
                                              ...
                                              <div class="col-lg-2 col-12 col-md-2">
                                                  <div class="cros-btn-wrap-m">
                                                      <button class="cart-cross-btn " type="button"><i class="fa-solid fa-xmark"></i></button>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-lg-6 col-6">
                                          <div class="d-flex align-items-center">
                                              <div>
                                                  <img src="./assets/images/order-p-img-1.png" class="img-fluid" alt="">
                                              </div>
                                              <div class="ms-4 ">
                                                  <h5 class="text-sm-hd-2 mb-0 ">AENEAN EGET RISUS UIS <br> LIGULA QUIS VIVE</h5>
                                                  <a href="./shop-views.php" class="text-mini-md-3 change ul">View Store</a>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="col-lg-6 col-6">
                                          ...
                                          <div class="col-lg-6 col-8">
                                              <div class="input-wrap mb-0">
                                                  <div class="input-area cart-input-a">
                                                      <input type="text" class="input-field" placeholder="Gift Card Or Discount Code">

                                                  </div>
                                              </div>
                                          </div>
                                          <div class="col-lg-5 col-3">
                                              <a class="primary-btn banner-btn location-btn" data-bs-toggle="modal" href="#exampleModalToggle" role="button">Search</a>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                          ...
                          <img src="./assets/images/leaf-bg-img.png" class="img-fluid leaf-img d-none d-lg-block" alt="">
                      </div>
                  </div>
              </div>
          </div>
