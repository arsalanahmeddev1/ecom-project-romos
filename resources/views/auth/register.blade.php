...
<div class="wrap-login-page sign-up">
  <div class="flex-grow flex flex-column justify-center gap30">
      ...
      <div class="login-box">
          ...
          @endif
          <form method="POST" action="{{route('register.store')}}" class="form-login flex flex-column gap24">
            @csrf
              <fieldset class="name">
              ...
              <fieldset class="password">
                  ...
                  <input class="password-input" type="password" placeholder="Enter your password" name="password_confirmation" tabindex="0" value="" aria-required="true" required="">
                  <span class="show-pass">
                      <i class="icon-eye view"></i>
                      <i class="icon-eye-off hide"></i>
                  </span>
