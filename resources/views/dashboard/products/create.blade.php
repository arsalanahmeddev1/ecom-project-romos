...
<div class="main-content">
  ...
  <div class="main-content-inner">
      ...
      <div class="main-content-wrap">
          ...
          <!-- form-add-product -->
          <form class="tf-section-2 form-add-product" method="POST" action="{{route('products.store')}}">
            @csrf
              <div class="wg-box">
                  <fieldset class="name">
                  ...
                  <fieldset class="slug">
                      ...
                      <input class="mb-10" type="text" placeholder="Enter product price" name="slug" tabindex="0" value="{{old('slug')}}">
                      @error('slug')
                      <span class="text-danger">{{$message}}"></span>
                      @enderror
                  </fieldset>
                  <fieldset class="price">
                      ...
                      <input class="mb-10" type="text" placeholder="Enter product price" name="price" tabindex="0" value="{{old('stock')}}" aria-required="true" required="">
                      <div class="text-tiny">Do not exceed 20 characters when entering the product name.</div>
                      @error('price')
                      <span class="text-danger">{{$message}}"></span>
                      @enderror
                  ...
                  <fieldset class="stock">
                      ...
                      <input class="mb-10" type="text" placeholder="Enter stock" name="stock" tabindex="0" value="{{old('price')}}" aria-required="true" required="">
                      <div class="text-tiny">Do not exceed 20 characters when entering the product name.</div>
                      @error('stock')
                      <span class="text-danger">{{$message}}"></span>
                      @enderror
